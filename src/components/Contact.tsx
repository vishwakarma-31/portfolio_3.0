        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 text-left">
          <div className="p-6 border border-zinc-800 rounded-xl bg-black/40">
            ...
            <p className="text-zinc-300 text-sm leading-relaxed mb-4">
             ...
             <Link href="/contact" className="text-white font-bold text-sm hover:text-indigo-400 transition-colors">Send Offer →</Link>
           </div>
           <div className="p-6 border border-zinc-800 rounded-xl bg-black/40">
             ...
             <Link href="/contact" className="text-white font-bold text-sm hover:text-indigo-400 transition-colors">Hire for Project →</Link>
           </div>
         </div>
