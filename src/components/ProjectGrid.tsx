              ...
              <div className="relative aspect-video overflow-hidden bg-zinc-900 border border-zinc-800 group-hover:border-indigo-500/50 transition-all duration-500">
                 ...
                 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                   <div className="flex gap-4">
                     <a href={project.deploymentUrl} target="_blank" rel="noopener noreferrer" className="relative z-20 text-xs font-mono uppercase tracking-widest text-indigo-400 hover:text-white transition-colors">Deployment →</a>
                     <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="relative z-20 text-xs font-mono uppercase tracking-widest text-white hover:text-indigo-400 transition-colors">Live Demo →</a>
                   </div>
                 </div>
              </div>
              <div className="mt-6">
